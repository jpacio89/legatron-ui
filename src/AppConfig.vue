<template>
    <div id="layout-config" :class="containerClass">
        <div class="layout-config-content">
            ...
            <TabView>
                <TabPanel header="Layout Customization">
                    <h5>Wrapper Modes</h5>
                    <div class="p-grid">
                        <div class="p-col p-col-fixed">
                            <a @click="changeWrapperMode($event, false)" :class="['layout-config-option', {'selected': (wrapperMode === false)}]"  >
                                <img src="assets/layout/images/configurator/wrapper/Boxed.png" alt="prestige" style="width:100%">
                                <i class="pi pi-check" v-if="wrapperMode === false"></i>
                            </a>
                        </div>
                        <div class="p-col p-col-fixed">
                            <a @click="changeWrapperMode($event, true)" :class="['layout-config-option', {'selected': (wrapperMode === true)}]"  >
                                <img src="assets/layout/images/configurator/wrapper/FullWidth.png" alt="prestige" style="width:100%">
                                <i class="pi pi-check" v-if="wrapperMode === true"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="p-grid">
                        <div class="p-col p-col-fixed">
                            <a @click="changeLayoutMode($event, 'horizontal')" :class="['layout-config-option', {'selected': (layoutMode === 'horizontal')}]" >
                        ...
                        <div class="p-col p-col-fixed">
                            <a @click="changeLayoutMode($event, 'overlay')" :class="['layout-config-option', {'selected': (layoutMode === 'overlay')}]"  >
                    ...
                    <div class="p-grid">
                        <div class="p-col p-col-fixed colors" v-for="l of layoutThemesColored" :key="l.name">
                            <a @click="changeLayoutTheme($event, l.file, l.componentTheme)" :class="['layout-config-option', {'selected': (layout === l.file)}]" :title="l.name" :style="{backgroundImage: `linear-gradient(to right, ${l.color1}, ${l.color2})`}">
                    ...
                    <h5>Image Themes</h5>
                    <div class="p-grid">
                        <div class="p-col p-col-fixed colors" v-for="l of layoutThemesImage" :key="l.name">
                            <a @click="changeLayoutTheme($event, l.file, l.componentTheme)" :class="['layout-config-option', {'selected': (layout === l.file)}]" :title="l.name">
