	...
	<div class="p-grid messages-demo">
		...
		<div class="p-col-12 p-lg-6">
			<div class="card">
				...
				<Button label="Success" @click="addMessage('success')" class="p-button-success p-mr-2"/>
				<Button label="Info" @click="addMessage('info')" class="p-button-info p-mr-2"/>
				<Button label="Warn" @click="addMessage('warn')" class="p-button-warning p-mr-2"/>
				<Button label="Error" @click="addMessage('error')" class="p-button-danger p-mr-2"/>
		...
		<div class="p-col-12 p-lg-8">
			<div class="card">
				...
				<div class="p-field p-grid p-align-start">
					<div class="p-col">
						<InputText id="username1" v-model="username" :required="true" class="p-invalid" placeholder="Username"></InputText>
						<InlineMessage>Field is required</InlineMessage>
					</div>
				</div>
				<div class="p-field p-grid">
					<div class="p-col">
						<InputText id="email" v-model="email" :required="true" class="p-invalid" placeholder="Email"></InputText>
						<InlineMessage/>
					</div>
				</div>
			</div>
