...
"npm run test:unit": Runs the tests.
                ...
                <p>Prestige consists of 2 main parts; the application layout and the resources. <i>App.vue</i> inside src folder is the main component containing the template for the base layout
                    whereas required resources such as SASS structure for the layout are placed inside the <b>public/assets/layout</b> folder.</p>
...
import './App.scss'; 	                            //your styles and overrides
                ...
                <p>Prestige provides 17 PrimeVue themes out of the box. Setup of a theme is simple by including the css of theme to your bundle that are located inside assets/theme folder such as assets/theme/theme-pink.css.
...
sass --watch public/assets:public/assets
                ...
                <ul>
                    ...
                    <li>Define the variables listed below and import the <i>../../sass/layout/_layout.scss</i>.</li>
