		...
		<div class="p-grid dashboard">
					...
					<div class="weather-wrapper">
						<div class="weather-days">
							...
							<div class="weather-today">
								...
								<img src="assets/layout/images/dashboard/icon-rain.svg" alt="">
							</div>
							<ul>
								<li>
			...
			<div class="p-col-12 p-lg-8">
				<div class="card table">
					<h5>Inventory</h5>
					<DataTable :value="products" class="p-datatable-responsive-demo" v-model:selection="selectedProduct" selectionMode="single" dataKey="id" :rows="5" style="margin-bottom: 20px" :paginator="true">
						<Column>
							<template #header>
								Logo
							</template>
						...
						<Column>
							...
							<template #body>
								<Button icon="pi pi-search" type="button" class="p-mr-2"></Button>
